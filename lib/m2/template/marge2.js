...
function run_all(gl) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree';
    d3.json(gl + "_delta_batch_H3K27ac_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });

    d3.json(gl + "_delta_batch_H3K27ac_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree2';
    d3.json(gl + "_delta_batch_DNase_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });

    d3.json(gl + "_delta_batch_DNase_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree3';
    d3.json(gl + "_delta_batch_H3K4me1_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });

    d3.json(gl + "_delta_batch_H3K4me1_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree4';
    d3.json(gl + "_delta_batch_H3K4me3_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });

    d3.json(gl + "_delta_batch_H3K4me3_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree5';
    d3.json(gl + "_delta_batch_H3K4me2_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_H3K4me2_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree6';
    d3.json(gl + "_delta_batch_ATAC-seq_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_ATAC-seq_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree7';
    d3.json(gl + "_delta_batch_H3K9ac_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_H3K9ac_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree8';
    d3.json(gl + "_delta_batch_H3K27me3_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_H3K27me3_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree9';
    d3.json(gl + "_delta_batch_H3K36me3_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_H3K36me3_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
    ...
    var mytype = 'margerp';
    var dom = 'svg.tree10';
    d3.json(gl + "_delta_batch_H3K9me3_withpromoter_nodnase_99.json",
    function(error, data) {
    draw(error, data, mytype, dom);
    });
    d3.json(gl + "_delta_batch_H3K9me3_withpromoter_nodnase_cistrome_dc.json", function(error, data) {
